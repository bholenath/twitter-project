...
class Translator(object):
    translate_url = "https://www.googleapis.com/language/translate/v2?key=AIzaSyB5deUn7QXYe5WKUtAe17Ib6l8GvV_4Zkc&q=%(message)s&target=en&source=es"
...
class LanguageDetector(object):
    detect_url =  "https://www.googleapis.com/language/translate/v2/detect?q=%(message)s&key=AIzaSyB5deUn7QXYe5WKUtAe17Ib6l8GvV_4Zkc"
