...
query1 = """ select nodes,weight from celebrity_number_unique_users """
cursor.execute(query1)
result1 = cursor.fetchall()

query2 = """ select count(*) from celebrity_number_unique_users """
cursor.execute(query2)
result2 = cursor.fetchall()

query3 = """ select source,target,weight from celebrity_users_common """
...
plot(g, "twitter_network_common_users_fr_g.svg", **visual)
g.write_graphml("common_users_fr_g.graphml")
