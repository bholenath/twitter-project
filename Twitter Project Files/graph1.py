...
query1 = """ select nodes,weight from celebrity_mentions_count """
cursor.execute(query1)
result1 = cursor.fetchall()

query2 = """ select count(*) from celebrity_mentions_count """
cursor.execute(query2)
result2 = cursor.fetchall()

query3 = """ select source,target,weight from celebrity_common_mention_tweets """
...
#g.__plot__(community,bbox=(1000,1000),palette,**visual)
plot(g, "twitter_network_common_mention_fr_g1.svg", **visual)
g.write_graphml("common_mention_fr_g1.graphml")
